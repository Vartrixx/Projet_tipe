...
def convert_frequencies_to_notes(resultats):
    """
    Convertit une liste de fréquences en notes musicales.

    Paramètres :
        frequencies (list) : Liste de fréquences à convertir.

    Retourne :
        notes (list) : Liste des notes correspondantes.
    """
    return [(temps,frequency_to_note(freq)) for temps,freq in resultats]
